...
Unfortunately, my [local electricity provider](https://www.swlb.de/) did not approve the installation of a 22kW charging station (wallbox). I am allowed to draw a maximum grid power of 11,000 Watts, but not up to 22kW. 
Mid 2020 I had installed a photovoltaic power system capable of providng a peak power of up to 9,900 Watts. My plan was to dynmacially increase the maximum wallbox power by the amount of energy produced my the photovoltaic system. For example, when my PV system produces 5,600 Watts I want to allow my wallbox to charge with 15,500 Watts (11,000 + 5,600) instaed of only 11,000 Watts.

## The Challenge

By default my Fronius inverter only support a few selected wall box chargers, like the Keba KeConteact P30 or the eCharge cPH1 Wallbox. Of course, my Vestel wallbox is not on the list of supported wallboxes. Therefore, I decided to start this project to build my own simple power management or balancing device. It's a straight-forward hands-on power management which I've implemented using a Raspberry Pi Zero W single board computer and some peripherals.

## Photovoltaic System

My photovoltaic system consists of 28 pioeces Hanwa Q-Cells solar modules which produce a maximum peak power (Wp) of 9,900 Watts at full bright sunlight.

## The Inverter

My inverter device is a **Fronius Symo 10.0-3-M**. My wallbox is a **Vestel EVC04-AC22-T2P eMobility** charging device.
...
Activate the onboard SPI interface of your Raspberry 
Pi by running raspi-config
